...
public class ComponentUtil {
    ...
    @Contract(pure = true)
    public static @NotNull String asJson(@NotNull Component component) {
        return GsonComponentSerializer.gson().serialize(component);
    }

    @Contract(pure = true)
    public static @NotNull Component toComponent(@NotNull String json) {
        return GsonComponentSerializer.gson().deserialize(json);
    }

    @Contract(pure = true)
    public static @NotNull List<String> asJson(@NotNull List<Component> component) {
        List<String> jsonList = new ArrayList<>();
        for (Component line : component) {
            jsonList.add(asJson(line));
        }
        return jsonList;
    }

    @Contract(pure = true)
    public static @NotNull List<Component> toComponent(@NotNull List<String> json) {
        List<Component> componentList = new ArrayList<>();
        for (String line : json) {
            componentList.add(toComponent(line));
        }
